...
export type ImpureCircuits<T> = {
  post(context: __compactRuntime.CircuitContext<T>, messageprop: string): __compactRuntime.CircuitResults<T, void>;
...
export declare class Contract<T, W extends Witnesses<T> = Witnesses<T>> {
  ...
  initialState(context: __compactRuntime.ConstructorContext<T>,
               titleprop: string): __compactRuntime.ConstructorResult<T>;
}
