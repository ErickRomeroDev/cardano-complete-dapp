...
} from "@/lib/quetion-contract";
import {
  BBoardDerivedState,
  DeployedBBoardAPI,
} from "@/lib/quetion-contract/api";
import { STATE } from "@/lib/quetion-contract/contract";
...
export const Board = ({ address, index }: BoardProps) => {
  ...
  const onJoinBoard = (contractAddress: ContractAddress) =>
    quetionsApiProvider.resolve(contractAddress);
  ...
  return (
    ...
    >
      <div className="w-full pl-2 text-[17px] leading-tight">
